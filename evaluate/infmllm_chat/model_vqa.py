...
from evaluate.infmllm_chat.utils import tokenizer_image_token, KeywordsStoppingCriteria
...
def eval_model(args):
    ...
    print("image_size: {}".format(model.config.image_size))
    print("pool_out_size: {}".format(model.config.pool_out_size))
